...
| **Tables**                   | GFM tables are styled under `.signal-prose table`. Use `---:` column alignment for numeric columns — right-aligned cells sit flush to the table edge with hairline rules.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
