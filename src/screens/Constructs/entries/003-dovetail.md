...
A lightweight reverse proxy that automatically exposes Docker containers to your [Tailnet](https://tailscale.com/) over HTTPS. Add labels to your containers and they become accessible as secure endpoints on your private network.
